from pgntraverse import ChessParser
from branch import Memory
import pgntraverse


memory = Memory()
memory.read_from_file("input/memory.txt")

parser = ChessParser(memory)
...
parser.parse_file("input/lichess_study_sicilian-gambit_by_guilherme_silveira_2023.09.20.pgn",
                  "sicilian/")

parser.parse_file("input/lichess_study_caro-a3_by_guilherme_silveira_2023.09.03.pgn",
                  "caro/")

parser.parse_file("input/lichess_study_french_by_guilherme_silveira_2023.09.23.pgn",
                  "french/")

parser.parse_file("input/lichess_study_scandinavian_by_guilherme_silveira_2023.09.25.pgn",
                  "scandinavian/")

parser.parse_file("input/lichess_study_my-vienna_by_guilherme_silveira_2023.09.25.pgn",
                  "vienna/")

print(pgntraverse.printer)